...
How to deal with storage and databases in AWS?

Basically, we will focus on RDS (Relational database service) and DynamoDB.

## Types of storage

There are two types of storage to be considered:
1. Block storage: divides the file into chunks to be saved,
2. Object storage: treats the file as a single unit.

*Object storage often follows the WORM (write once, read many) model.
